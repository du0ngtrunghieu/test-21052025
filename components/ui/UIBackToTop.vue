...
const scrollThreshold = 150 // Lower scroll threshold to make button appear earlier

// Listen for scroll events, use requestAnimationFrame for performance optimization
let ticking = false
function onScroll() {
  if (!ticking) {
...
// Scroll to top with smoother easing function
